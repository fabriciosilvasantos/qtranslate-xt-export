	...
	protected static function get_builtin_setup(): array {
		return array(
			array(
				'id'           => 'acf',
				'name'         => 'ACF',
				'plugins'      => array( 'advanced-custom-fields/acf.php', 'advanced-custom-fields-pro/acf.php' ),
			...
			array(
				...
				'plugins'      => array( 'events-made-easy/events-manager.php' ),
				'incompatible' => 'events-made-easy-qtranslate-x/events-made-easy-qtranslate-x.php',
			),
			array(
				'id'      => 'jetpack',
				'name'    => 'Jetpack',
				'plugins' => array( 'jetpack/jetpack.php' ),
			),
			array(
				'id'      => 'google-site-kit',
