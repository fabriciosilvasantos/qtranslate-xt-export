	...
	<div class="card" style="max-width: 800px; margin-top: 20px;">
		...
		<ol style="padding-left: 20px;">
			...
			<li style="<?php echo 'import' === $current_step ? 'color: #0073aa; font-weight: bold;' : 'color: #666;'; ?>">
				<?php echo esc_html__( 'Importacao, Reconstrucao de Hierarquia e Conexao de Traducoes (executadas automaticamente em sequencia)', 'qtx-polylang-migrator' ); ?> <?php if ( 'results' === $current_step ) echo 'OK'; ?>
			</li>
		</ol>
	</div>
	<?php
...
function qtxpm_render_wordpress_import_card( array|false $import_result ): void {
	...
	<div class="card" style="max-width: 800px; margin-top: 20px;">
		...
		<div class="notice notice-info">
			...
			<p><?php echo esc_html__( 'Este passo executa o pipeline completo automaticamente: importacao, reconstrucao de hierarquia e conexao de traducoes. Nenhuma acao manual adicional e necessaria.', 'qtx-polylang-migrator' ); ?></p>
		</div>
...
function qtxpm_render_results_card(): void {
	...
	<div class="card" style="max-width: 800px; margin-top: 20px;">
		...
		<hr />
		<h3><?php echo esc_html__( 'Reparar Duplicatas Orfas (opcional)', 'qtx-polylang-migrator' ); ?></h3>
		<p><?php echo esc_html__( 'A migracao acima ja conecta as traducoes automaticamente. Use esta acao apenas se reconhecer duplicatas orfas no site (por exemplo, apos reimportar o mesmo conteudo mais de uma vez): ela localiza duplicatas seguras por idioma, move orfaos para rascunho e reconecta os grupos no padrao do Polylang.', 'qtx-polylang-migrator' ); ?></p>
		<form method="post">
